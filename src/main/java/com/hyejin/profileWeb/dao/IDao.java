package com.hyejin.profileWeb.dao;

import com.hyejin.profileWeb.dto.MemberDto;
...
public interface IDao {
	...
	public void infoModify(String mpw, String mname, String memail, String mid);//회원정보수정
